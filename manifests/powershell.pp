...
#    }
    exec {'powershell4':
      ...
      onlyif => "cmd /c '$::systemroot\\system32\\WindowsPowershell\\v1.0\\powershell.exe -executionpolicy remotesigned if(\$PSVersionTable -and (\$PSVersionTable.PSVersion -ge [Version]'4.0')){exit 1}'"
